...
**NOTE**: This project is lightweight raft. If you are using swiftRaft in a project
and want to carry the project forward please file an issue with your ideas and
intentions. The project reference from the implementations of [etcd](https://godoc.org/github.com/coreos/etcd/raft) and [InfluxDB](https://godoc.org/github.com/influxdb/influxdb/raft).
...
If you have any questions on implementing swiftRaft in your project please file an issue.
...
These projects are built on swiftRaft:
